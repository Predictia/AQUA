...
def plot_gregory_monthly(t2m_monthly_data, net_toa_monthly_data,
    ...
    if ref:
        ...
        t2m_ref = xr.concat([t2m_ref, t2m_ref.isel(month=0)], dim='month', coords='different')
        net_toa_ref = xr.concat([net_toa_ref, net_toa_ref.isel(month=0)], dim='month', coords='different')
