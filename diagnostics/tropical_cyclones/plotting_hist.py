...
def plot_hist_cat(trajfile1, trajfile2, trajfile3, ibtracs_file=None):
    ...
    if ibtracs_file is not None:
        ...
        ax.bar(center - width/6, hist3 / total_traj3, align='center', width=width/4, label='ERA5', alpha=0.5)
    ...
    # save figure
    plt.savefig('/home/b/b382216/scratch/fullres/PDF/hist_wind.pdf', bbox_inches="tight")
...
def plot_press_wind(trajfile1, trajfile2, trajfile3, ibtracs_file=None):
    ...
    if ibtracs_file is not None:
        ...
        ax.scatter(xwind3, xpres3, s=30, alpha=0.2, marker="x", label='ERA5')  # ERA5 data
        ...
        fig, ax = plt.subplots(figsize=(8, 6))
        ax.scatter(xwind3, xpres3, s=30, alpha=0.4, marker="x", label='ERA5')  # ERA5 data
    ...
    # save figure
    plt.savefig('/home/b/b382216/scratch/fullres/PDF/slp_vs_wind.pdf', format='pdf')
    plt.show()
