...
def test_NAO(tmp_path):
    ...
    assert (os.path.exists(os.path.join(tmp_path, 'png', 'nao.index.ci.IFS.test-tco79.ci.IFS.test-tco79.r1.png'))) is True
    ...
    assert (os.path.exists(os.path.join(tmp_path, 'pdf', 'nao.regression_DJF.ci.IFS.test-tco79.ci.IFS.test-tco79.r1.pdf'))) is True
