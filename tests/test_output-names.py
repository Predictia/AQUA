...
def test_generate_name(output_namer):
    ...
    filename = output_namer.generate_name(diagnostic_product='mean', var='mtpr', model_2='ERA5', exp_2='era5',
                                          time_start='1990-01-01', time_end='1990-02-01', time_precision='ym',
                                          area='indian_ocean', frequency="3H", status="preliminary")
...
def test_save_netcdf(output_namer):
    ...
    path = output_namer.save_netcdf(dataset=data, diagnostic_product='mean', var='mtpr', model_2='ERA5', exp_2='era5',
                                    time_start='1990-01-01', time_end='1990-02-01', time_precision='ym',
                                    area='indian_ocean', frequency="3H", status="preliminary")
...
def test_save_pdf(output_namer):
    ...
    path = output_namer.save_pdf(fig=fig, diagnostic_product='mean', var='mtpr', model_2='ERA5', exp_2='era5',
                                 time_start='1990-01-01', time_end='1990-02-01', time_precision='ym',
                                 area='indian_ocean', frequency="3H", status="preliminary")
...
def test_save_png(output_namer):
    ...
    path = output_namer.save_png(fig=fig, diagnostic_product='mean', var='mtpr', model_2='ERA5', exp_2='era5',
                                 time_start='1990-01-01', time_end='1990-02-01', time_precision='ym',
                                 area='indian_ocean', frequency="3H", status="preliminary")
