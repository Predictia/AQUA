...
class TestGlobalBiases:
    ...
    def test_bias(self):
        ...
        pdf = os.path.join(self.tmp_path, 'pdf', f'globalbiases.bias.ci.ERA5.era5-hpz3.ERA5.era5-hpz3.r1.{self.var}.85000.pdf')
        assert os.path.exists(pdf)
        png = os.path.join(self.tmp_path, 'png', f'globalbiases.bias.ci.ERA5.era5-hpz3.ERA5.era5-hpz3.r1.{self.var}.85000.png')
        assert os.path.exists(png)
    ...
    def test_seasonal_bias(self):
        ...
        pdf = os.path.join(self.tmp_path, 'pdf', f'globalbiases.seasonal_bias.ci.ERA5.era5-hpz3.ERA5.era5-hpz3.r1.{self.var}.85000.pdf')
        assert os.path.exists(pdf)
        png = os.path.join(self.tmp_path, 'png', f'globalbiases.seasonal_bias.ci.ERA5.era5-hpz3.ERA5.era5-hpz3.r1.{self.var}.85000.png')
        assert os.path.exists(png)
    ...
    def test_vertical_bias(self):
        ...
        pdf = os.path.join(self.tmp_path, 'pdf', f'globalbiases.vertical_bias.ci.ERA5.era5-hpz3.ERA5.era5-hpz3.r1.{self.var}.pdf')
        assert os.path.exists(pdf)
        png = os.path.join(self.tmp_path, 'png', f'globalbiases.vertical_bias.ci.ERA5.era5-hpz3.ERA5.era5-hpz3.r1.{self.var}.png')
        assert os.path.exists(png)
