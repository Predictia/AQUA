...
def test_run_aqua_analysis():
    ...
    assert os.path.exists("./output/ci/IFS/test-tco79/r1/experiment.yaml"), "experiment.yaml not found"
    assert os.path.exists("./output/ci/IFS/test-tco79/r1/dummy.log"), "dummy.log not found"
    assert os.path.exists("./output/ci/IFS/test-tco79/r1/setup_checker.log"), "experiment.yaml not found"
