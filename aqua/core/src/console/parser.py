...
from aqua.console.analysis import analysis_parser
from aqua.console.drop import drop_parser
from aqua.console.catgen import catgen_parser
from aqua.console.builder import builder_parser
