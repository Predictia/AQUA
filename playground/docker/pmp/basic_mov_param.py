...
# MODEL SETTINGS
modpath = '/data/CMIP5_demo_data/psl_Amon_%(model)_historical_r1i1p1_185001-200512.nc'
modnames = ['ACCESS1-0']
varModel = 'psl' 
...
reference_data_path = '/data/obs4MIPs_PCMDI_monthly/NOAA-ESRL-PSD/20CR/mon/psl/gn/v20210727/psl_mon_20CR_PCMDI_gn_187101-201212.nc'
