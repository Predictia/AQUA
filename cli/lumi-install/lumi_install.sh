...
if ! grep -q 'module use /project/project_465000454/devaraju/modules/LUMI/23.03/C'  "~/load_aqua.sh" ; then
  ...
  echo 'export PATH=/users/lrb_465000454_fdb/mars/versions/6.99.1.3/bin:$PATH' >>  $load_aqua_file
  echo 'export LD_LIBRARY_PATH=/users/lrb_465000454_fdb/mars/versions/6.99.1.3/lib64:$LD_LIBRARY_PATH' >>  $load_aqua_file
